	...
	draw = function(self)
		love.graphics.push()
			...
			love.graphics.push()
				...
				if weekNum ~= 1 then
					love.graphics.printf("TRACKS" .. trackNames[weekNum][1] .. trackNames[weekNum][2] .. trackNames[weekNum][3], -1050, 140, 853, "center", nil, 1.5, 1.5, 255, 117, 172)
				else
					love.graphics.printf("TRACKS" .. trackNames[weekNum][1], -1050, 140, 853, "center", nil, 1.5, 1.5, 255, 117, 172)
				end
