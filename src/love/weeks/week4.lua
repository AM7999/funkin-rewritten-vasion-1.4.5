...
return {
	...
	load = function(self)
		...
		inst = love.audio.newSource("music/mekatsune/mekatsune-inst.ogg", "stream")
		voices = love.audio.newSource("music/mekatsune/mekatsune-voices.ogg", "stream")
	...
	initUI = function(self)
		...
		weeks:generateNotes(love.filesystem.load("charts/mekatsune/mekatsune" .. difficulty .. ".lua")())
	end,
